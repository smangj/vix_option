...
CALENDAR_URL_BASE = (
    "http://push2his.eastmoney.com/api/qt/stock/kline/get?secid="
    "{market}.{bench_code}&fields1=f1%2Cf2%2Cf3%2Cf4%2Cf5&fields2="
    "f51%2Cf52%2Cf53%2Cf54%2Cf55%2Cf56%2Cf57%2Cf58&klt=101&fqt=0&beg=19900101&end=20991231"
)
    ...
    def _get_eastmoney():
        ...
        try:
            ...
            for sub_data in re.findall(
                ...
                # TODO: do we need other information, like fund_name from
...
def get_instruments(
    ...
    _cur_module = importlib.import_module(
        "qlib_scripts.data_collector.{}_collector".format(market_index)
    )
